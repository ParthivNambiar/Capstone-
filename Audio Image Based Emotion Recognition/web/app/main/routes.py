...
def process_audio_and_transcript():
    ...
    try:
        ...
        if transcript !='':
            ...
            return jsonify({'status': 'success', 'message': 'Audio and transcript processed successfully','emotion':text_emotion})
        ...
        return jsonify({'status': 'success', 'message': 'Audio and transcript processed successfully,bc'})
